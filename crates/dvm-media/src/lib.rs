//! Trusted native and sidecar media processing for Digital Vault of Memories.
//!
//! # Gate status
//!
...
//! by Blueprint v2 and is authorised only from **G6** onwards. Adding
//! implementation here before G6 is authorised would violate the gate
...
pub const AUTHORISED_FROM_GATE: &str = "G6";
