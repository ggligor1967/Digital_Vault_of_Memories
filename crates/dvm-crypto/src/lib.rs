//! Cryptographic primitives, key hierarchy and DVB1 blob framing for Digital Vault of Memories.
//!
//! # Gate status
//!
...
//! by Blueprint v2 and is authorised only from **G2** onwards. Adding
//! implementation here before G2 is authorised would violate the gate
...
pub const AUTHORISED_FROM_GATE: &str = "G2";
