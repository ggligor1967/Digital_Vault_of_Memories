//! DVBK1 backup, verification and restore for Digital Vault of Memories.
//!
//! # Gate status
//!
...
//! by Blueprint v2 and is authorised only from **G3** onwards. Adding
//! implementation here before G3 is authorised would violate the gate
