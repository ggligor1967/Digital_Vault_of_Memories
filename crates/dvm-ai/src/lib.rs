//! Optional, capability-scoped AI provider adapters for Digital Vault of Memories.
//!
//! # Gate status
//!
...
//! by Blueprint v2 and is authorised only from **G5** onwards. Adding
//! implementation here before G5 is authorised would violate the gate
...
pub const AUTHORISED_FROM_GATE: &str = "G5";
